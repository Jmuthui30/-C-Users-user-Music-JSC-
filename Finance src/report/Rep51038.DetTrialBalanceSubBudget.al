report 51038 "Det. Trial Balance-Sub Budget"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report_layout/DetailedTrialBalanceBySubBudget.rdl';
    ApplicationArea = All;
    ...
    var
        ...
        DetailTrialBalCaptionLbl: Label 'Detail Trial Balance by Sub Budget';
