report 51039 "Det. Trial Bal-Sub Budget Add."
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report_layout/DetailedTrialBalanceAdditionalBySubBudget.rdl';
    ApplicationArea = All;
        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem("G/L Entry"; "G/L Entry")
                {
                    ...
                    column(DebitAmount_GLEntry; "Add.-Currency Debit Amount")
                    {
                    }
                    column(CreditAmount_GLEntry; "Add.-Currency Credit Amount")
                    {
                    }
                    ...
                    begin
                        if PrintOnlyCorrections then
                            if not (("Add.-Currency Debit Amount" < 0) or ("Add.-Currency Credit Amount" < 0)) then
                                CurrReport.Skip();
    ...
    var
        ...
        DetailTrialBalCaptionLbl: Label 'Detail Trial Balance by Sub Budget (Additional Currency)';
