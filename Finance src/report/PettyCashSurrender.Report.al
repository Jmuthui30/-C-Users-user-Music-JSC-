report 51005 "Petty Cash Surrender"
{
    ApplicationArea = All;
    Caption = 'Petty Cash Surrender';
    DefaultLayout = RDLC;
    RDLCLayout = './src/report_layout/PettyCashSurrender.rdl';
    dataset
    {
        dataitem(Payments; Payments)
        {
            ...
            column(PettyCashIssueDocNo_Payments; Payments."Petty Cash Issue Doc.No")
            {
            }
            ...
            trigger OnPreDataItem()
            begin
                Payments.CalcFields("Petty Cash Amount", "Actual Petty Cash Amount Spent");
            end;
            ...
            begin
                ...
                PaymentMgt.FormatNoText(NumberText, "Actual Petty Cash Amount Spent", Currency);
