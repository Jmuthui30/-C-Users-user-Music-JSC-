report 51021 "Commitment Entries"
{
    ApplicationArea = All;
    Caption = 'Commitment Entries';
    DefaultLayout = RDLC;
    RDLCLayout = './src/report_layout/CommitmentEntries.rdlc';
    dataset
    {
        dataitem("Commitment Entries"; "Commitment Entries")
        {
            // DataItemTableView = where("Commitment Type" = filter(Commitment));
            // RequestFilterFields = "Global Dimension 1 Code", "Global Dimension 2 Code", "Document Type", "Commitment Date";
            ...
            // {
            // } */
            // column(GlobalDimension1_CommitmentEntries; "Commitment Entries"."Global Dimension 1 Code")
            // {
            // }
            // column(GlobalDimension2_CommitmentEntries; "Commitment Entries"."Global Dimension 2 Code")
            // {
            // }
            ...
            area(Content)
            {
                group(Control2)
                {
                    ...
                    field("""Commitment Entries"".Account"; "Commitment Entries".Account)
                    {
                        ...
                        ToolTip = 'Specifies the value of the Vote No. (Account No) field';
                    }
                }
            }
        }
