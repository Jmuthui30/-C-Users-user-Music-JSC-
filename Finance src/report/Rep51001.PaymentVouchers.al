report 51001 "Payment Vouchers"
{
    ApplicationArea = All;
    Caption = 'Payment Voucher';
    DefaultRenderingLayout = "PV-AACC";
    UsageCategory = None;
    dataset
    {
                            ...
                            begin
                                ...
                                if VendLedgerEntry.Find('-') then begin
                                    ...
                                    if VendLedgerEntry2.Find('-') then
                                        InvoiceNo := CopyStr(VendLedgerEntry2."External Document No.", 1, MaxStrLen(InvoiceNo));
                                end;
                            end;
                    end;
                end;
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/report_layout/PaymentVoucher.rdl';
            Caption = 'Payment Voucher';
        }
        layout(PV2)
        {
            Type = RDLC;
            LayoutFile = './src/report_layout/PV.rdl';
            Caption = 'Payment Voucher';
        }
        layout("PV-AACC")
        {
            Type = RDLC;
            LayoutFile = './src/report_layout/PV-AACC.rdl';
            Caption = 'Payment Voucher';
        }
        layout("PV-CH")
        {
            Type = RDLC;
            LayoutFile = './src/report_layout/PV-CH.rdl';
            Caption = 'Payment Voucher';
        }
    }
