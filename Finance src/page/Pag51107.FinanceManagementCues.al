    ...
    layout
    {
        area(Content)
        {
            ...
            cuegroup("Finance Documents - Approved")
            {
                ...
                // field("Imprest Memos-Approved";"Imprest Memos-Approved")
                // {
                //     Caption = 'Imprests Memos-Approved';
                //     DrillDownPageId = "Approved Imprests";
                //     ToolTip = 'Specifies the value of the Imprests-Approved field';
                // }
                ...
                field("Imprest Memo Approved"; Rec."Imprest Memos-Approved")
                {
                    Caption = 'Imprest Memo - Approved';
                    DrillDownPageId = "Imprest Memo List Appr";
                    ToolTip = 'Specifies the value of the Imprest Memo field';
                }
            ...
            cuegroup("Finance Documents - Posted")
            {
                ...
                field("Imprest Memo Approved2"; Rec."Imprest Memos-Approved")
                {
                    Caption = 'Imprest Memo - Created';
                    DrillDownPageId = "Imprest Memo List Appr";
                    ToolTip = 'Specifies the value of the Imprest Memo field';
                }
