// report 52042 "Earning"
// {
//     ApplicationArea = All;
//     DefaultLayout = RDLC;
//     RDLCLayout = './src/report_layout/Earnings.rdl';
//     Caption = 'Earnings';
//     dataset
//     {
...
//                     DataItemTableView = sorting("Employee No", Type, Code, "Payroll Period", "Reference No") where(Type = const(Earning), "Employee type" = filter(<> trustee));
