report 52208 "AHL Report"
{
    Caption = 'AHL Report';
    RDLCLayout = './Reports/SSRS/AHLReport.rdlc';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Employee No", Type, Code, "Payroll Period", "Reference No") WHERE(Type = CONST(Deduction), Code = const('ED117'));
            RequestFilterFields = "Payroll Period";
            RequestFilterHeading = 'AHL Report';
