report 52238 "Master Roll Report II"
{
    ApplicationArea = All;
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("No.") where("Employee Job Type" = const("  "));/*, "Employee Type" = filter(<> "Board Member"), Status = const(Active),Status=const(Active)*/
            ...
            begin
                ...
                for i := NoOfEarnings + 1 to NoOfEarnings + NoOfDeductions do begin
                    ...
                    if Assignmat.FindSet() then begin
                        ...
                        repeat
                            Allowances[i] += Assignmat.Amount;
                            TotalLoanInterest += Assignmat."Loan Interest"; // + Assignmat."Loan Interest";
                        until Assignmat.Next() = 0;
                        TotalDeductions := TotalDeductions + Allowances[i] + TotalLoanInterest;
                    end else
