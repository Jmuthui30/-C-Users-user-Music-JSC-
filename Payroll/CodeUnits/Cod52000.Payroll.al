                ...
                if Ded.Find('-') then
                    repeat
                        ...
                        IF Assignmatrix.FIND('-') THEN BEGIN
                            ...
                            ArrEarnings := 'Housing Levy Contribution';
...
*/
    ...
    var
        AssMatrix: Record "Assignment Matrix";
        Ded: Record Deduction;
        ScaleBenefits: Record "Scale Benefits II";
        Begindate: Date;
        PayAmount: Decimal;
    ...
    begin
        if not SalaryPointerIncrement.Get(Employee."No.", PayPeriod) then begin
            ...
            SalaryPointerIncrement.Validate("Increment Date", Employee."Last Date Increment");
