table 53037 "Employee Acting Position"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = sum("Scale Benefits".Amount where(Scale = field("Current Scale"),
        ...
        {
            CalcFormula = sum("Scale Benefits".Amount where(Scale = field("New Scale"),
