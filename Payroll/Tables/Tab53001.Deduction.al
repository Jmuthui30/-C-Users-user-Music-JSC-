table 53001 "Deduction"
{
    ...
    fields
    {
        ...
        {
            TableRelation = Deduction where(Voluntary = const(true));
        ...
        field(91; "Paye Allocation"; Boolean)
        {
            Caption = 'Paye Allocation';
        }
        field(92; "Provident Fund";Boolean)
        {
            
        }
        field(93; "Country Code"; Code[50])
        {
