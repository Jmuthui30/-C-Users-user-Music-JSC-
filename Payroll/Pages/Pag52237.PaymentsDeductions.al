    ...
    begin
        if Rec.Description = '' then begin
            case Rec.Type of
                Rec.Type::Earning:
                    begin
                        if Earnings.Get(Rec.Code) then begin
                            Rec.Description := Earnings.Description;
                            Rec.Modify();
                        end;
                    end;
                ...
                Rec.Type::Deduction:
                    begin
                        if Deductions.Get(Rec.Code) then begin
                            Rec.Description := Deductions.Description;
                            Rec.Modify();
                        end;
                    end;
            end;
