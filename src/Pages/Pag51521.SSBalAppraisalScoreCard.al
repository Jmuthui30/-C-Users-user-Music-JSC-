page 51521 "SS Bal Appraisal Score Card"
{
    PageType = Card;
    DeleteAllowed = false;
    InsertAllowed = false;
    ...
    layout
    {
        area(Content)
        {
            ...
            part(Control17; "Bal Appraisal Score Card Lines")
            {
                Editable = Rec.Status = Rec.Status::Open;
                ApplicationArea = All;
                SubPageLink = DocNo=FIELD("No."), "Progress Review Period"=field("Progress Review Period");
    ...
    Text000: Label 'You QuantumJump havent been set please Contact Admin';
