page 51501 "Staff Applicant Card"
{
    // version THL- HRM 1.0
    ...
    actions
    {
        area(Processing)
        {
            action("Submit Application")
            {
                ...
                Visible = ((Rec."Recruitment Need" <> '')); //AND (Rec."Application Submited" = false));

                trigger OnAction()
                begin
                    RecruitmentMgnt.SubmitStaffApplication(Rec);
                end;
            }
