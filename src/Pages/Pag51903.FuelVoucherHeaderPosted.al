page 51903 "Fuel Voucher Header-Posted"
{
    // version THL- PRM 1.0
    ...
    actions
    {
        area(processing)
        {
            action("Re-Print Fuel Vouchers")
            {
                ...
                trigger OnAction()
                begin
                    if Confirm('Are you sure you want to re-print the fuel voucher(s)', false) = true then begin
