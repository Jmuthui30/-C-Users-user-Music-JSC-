page 51771 "Qualitative Deliverables Other"
{
    // version THL- HRM 1.0
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control28; "Quantiitative Responses")
            {
                ApplicationArea = All;
                SubPageLink = "Employee No"=FIELD("Employee No"), "Review Start Date"=FIELD("Review Start Date"), "Review End Date"=FIELD("Review End Date"), Section=CONST(B);
            }
            group(Review)
            {
                Editable = false;
