page 52244 "Appraisals UnderReview FY"
{
    ApplicationArea = All;
    Caption = 'Appraisals UnderReview Finalyear';
    CardPageID = "Appraisal Card-Review";
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = List;
    SourceTable = "Employee Appraisal";
    SourceTableView = where(Status = filter("Mid-Year Approved" | "Pending Approval" | Released),
                            "Appraisal Status" = filter(Review | Set),
                            AppraisalType = const("Final Year"));
