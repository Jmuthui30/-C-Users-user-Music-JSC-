page 51703 "Applicant List-Offer Accepted"
{
    // version THL- HRM 1.0
    Caption = 'Offers Accepted';
    CardPageID = "Applicant Card-Offer Accepted";
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    PageType = List;
    ...
    SourceTableView = WHERE("Offer Status"=CONST("Accepted Offer"), Shortlisting=CONST(Passed));
