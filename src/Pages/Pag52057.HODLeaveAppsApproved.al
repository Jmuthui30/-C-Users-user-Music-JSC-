page 52057 "HOD Leave Apps - Approved"
{
    // version THL- HRM 1.0
    Caption = 'HOD Leave Application Approved';
    CardPageID = "HOD Leave App - Approved";
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    PageType = List;
    ...
    SourceTableView = WHERE("HOD Created"=CONST(true), Status=CONST(Released));
