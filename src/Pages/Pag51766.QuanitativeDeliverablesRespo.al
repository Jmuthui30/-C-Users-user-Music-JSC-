page 51766 "Quanitative Deliverables Respo"
{
    // version THL- HRM 1.0
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control28; "SS Quantitative Response")
            {
                ApplicationArea = All;
                SubPageLink = "Employee No"=FIELD("Employee No"), "Review Start Date"=FIELD("Review Start Date"), "Review End Date"=FIELD("Review End Date");
            }
            group(Review)
            {
                Editable = false;

                field("Appraisee Score Section A"; Rec."Appraisee Score Section A")
                {
                    ApplicationArea = All;
                    Editable = false;
                }
                field("Appraiser Score Section A"; Rec."Appraiser Score Section A")
                {
                    ApplicationArea = All;
                    Editable = false;
                }
                ...
                begin
                    ...
                    if Qualitative.FindSet then begin
                        repeat QualitativeResponse.Init;
                            ...
                            QualitativeResponse."Further Explanation":=Qualitative."Further Description";
                            QualitativeResponse."Marks Base":=Qualitative.Marks;
                            QualitativeResponse.Timeline:=Qualitative.Timelines;
    ...
    Qualitative: Record "Quantitativ Deliverables Setup";
    QualitativeResponse: Record "Appraisal Details Quantitative";
}
