page 51705 "Applicant List-Offer Rejected"
{
    // version THL- HRM 1.0
    Caption = 'Offers Rejected';
    CardPageID = "Applicant Card-Offer Rejected";
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    PageType = List;
    ...
    SourceTableView = WHERE("Offer Status"=CONST("Rejected Offer"), Shortlisting=CONST(Passed));
