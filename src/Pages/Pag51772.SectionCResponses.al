page 51772 "Section C Responses"
{
    // version THL- HRM 1.0
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control28; "Qualitative Responses")
            {
                ApplicationArea = All;
                SubPageLink = "Employee No"=FIELD("Employee No"), "Review Start Date"=FIELD("Review Start Date"), "Review End Date"=FIELD("Review End Date"), Section=CONST(C);
            }
            group(Review)
            {
                Editable = false;
