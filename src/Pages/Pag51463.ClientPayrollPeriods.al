page 51463 "Client Payroll Periods"
{
    // version THL- Client Payroll 1.0
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Administration;
    SourceTable = "Client Payroll Period";
    ...
    actions
    {
        area(processing)
        {
            action("Create Periods")
            {
                ...
                Promoted = true;
                PromotedIsBig = true;
                RunObject = Report "Create Client Payroll Period";
            }
    ...
    var ClosePayPeriod: Report "Close Client Pay period";
}
