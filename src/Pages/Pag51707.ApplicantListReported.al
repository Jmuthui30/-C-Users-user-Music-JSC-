page 51707 "Applicant List-Reported"
{
    // version THL- HRM 1.0
    Caption = 'Reported To Work';
    CardPageID = "Applicant Card-Reported";
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    PageType = List;
    ...
    SourceTableView = WHERE("Offer Status"=CONST("Reported to Work"), Shortlisting=CONST(Passed));
