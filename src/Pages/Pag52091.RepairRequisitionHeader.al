page 52091 "Repair Requisition Header"
{
    //Ibrahim Wasiu 
    Caption = 'Repair Requisition';
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Repair Service Level"; Rec."Repair Service Level")
                {
                    ApplicationArea = All;
                }
                ...
                field("Repair End Date"; Rec."Repair End Date")
                {
                    ApplicationArea = All;
                }
                ...
                field("Pending Approvals"; Rec."Pending Approvals")
                {
                    ...
                    begin
                        Entries.Reset();
                        Entries.SetRange("Table ID", 51935);
            ...
            group(Fault)
            {
                ...
                field("Fault Area"; Rec."Fault Area")
                {
                    ApplicationArea = All;
                    ShowMandatory = true;
                }
                ...
                field("Fault Date"; Rec."Fault Date")
                {
                    ApplicationArea = All;
                }
                field("Repair Notes"; Rec."Repair Notes")
                {
                    ApplicationArea = All;
                    MultiLine = true;
                    ShowMandatory = true;
