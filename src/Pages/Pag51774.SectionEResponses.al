page 51774 "Section E Responses"
{
    // version THL- HRM 1.0
    ...
    layout
    {
        area(content)
        {
            ...
            group(Review)
            {
                field("Courses Attended"; Rec."Courses Attended")
                {
                    ApplicationArea = All;
                    MultiLine = true;
                }
                field("Traning Need"; Rec."Traning Need")
                {
                    ApplicationArea = All;
                    MultiLine = true;
                }
                ...
                field("Overal Performance Grade"; Rec."Overal Performance Grade")
                {
                    ApplicationArea = All;
                }
            ...
            group("Appraisee Concurrence")
            {
                field("Agreed with Appraiser"; Rec."Agreed with Appraiser")
                {
                    ApplicationArea = All;
                    MultiLine = true;
                }
                field("Disagreement Reasons"; Rec."Disagreement Reasons")
                {
                    ApplicationArea = All;
                    MultiLine = true;
                }
            ...
            group(Recommendations)
            {
                ...
                field("MD/CEO Comments"; Rec."MD/CEO Comments")
                {
                    ApplicationArea = All;
                    MultiLine = true;
                }
