page 51456 "Client Payroll List"
{
    // version THL- Client Payroll 1.0
    //list of all employees
    Caption = 'Client Employee Master';
    ...
    trigger OnOpenPage()
    begin
        IF UserSetup.GET(USERID)THEN //Message('ID%1', UserId);
            IF NOT UserSetup.Payroll THEN ERROR(TEXT001);
    end;
    var PayrollInt: Codeunit "Client Payroll Mgt";
    UserSetup: Record "User Setup";
    TEXT001: Label 'Kindly Note that you are not Allowed to View the Payroll.Consult your System Administrator for Setup';
}
