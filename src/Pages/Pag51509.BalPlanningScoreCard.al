page 51509 "Bal Planning Score Card"
{
    PageType = Card;
    InsertAllowed = false;
    DeleteAllowed = false;
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Appraisal Doc No"; Rec."Appraisal Doc No")
                {
                    ApplicationArea = All;
                }
            ...
            part(Control17; "Bal Planning Score Card Lines")
            {
                Editable = Rec.Status = Rec.Status::Open;
                ApplicationArea = All;
        ...
        area(Processing)
        {
            action("Create Appraisal")
            {
                ...
                begin
                    ...
                    BalScoreCardMgnt.CreateAppraisalFromPlanning(Rec);
                end;
            }
