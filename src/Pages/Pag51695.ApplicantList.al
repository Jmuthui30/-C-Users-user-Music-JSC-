page 51695 "Applicant List"
{
    ...
    //SourceTableView = WHERE("Offer Status"=CONST(Applicant), Shortlisting=CONST(Passed), Interview=const(Passed), "Mediacal Examination"=const(Passed));
