codeunit 50001 "Attachment Management"
{
    ...
    begin
        case RecRef.Number of
            Database::"Requisition Header", Database::"Company Jobs", Database::Applicant, // Database::"Recruitment Plan",
                                                                                           // Database::"Consolidated Recruitment Plan",
                                                                                           // Database::"Job Requisition",
                                                                                           // Database::"Staff Orientations",
                                                                                           // Database::"Leave Plan",
...
Database::"Leave Application":
    ...
    procedure UploadPortalFilePath(RecordID: RecordID; FileName: Text[250]; FileExtension: Text[30]; CreatedBy: Code[50]; FilePath: Text[250]): Boolean
    var
...
Database::"Leave Application":
    ...
    local procedure LastDocumentAttachmentNo(): Record "Document Attachment"
    var
        DocumentAttachment: Record "Document Attachment";
    begin
