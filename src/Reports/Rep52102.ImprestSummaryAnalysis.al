report 52102 "Imprest Summary Analysis"
{
    // version THL- ADV.FIN 1.0
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Imprest Summary Analysis.rdl';
    ...
    dataset
    {
        dataitem("Imprest Header"; Payments)
        {
            ...
            column(TotalRefund; "Imprest Header"."Remaining Amount")
            {
            }
            column(NetRefundClaim; "Imprest Header"."Total Net Amount")
            {
            }
        }
    }
