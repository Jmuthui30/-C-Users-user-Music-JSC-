report 52024 "Payroll Reconciliation test"
{
    ApplicationArea = Basic, Suite;
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Payroll Reconciliationtest.rdlc';
    ...
    dataset
    {
        dataitem("Assignment Matrix-X"; "Client Payroll Matrix")
        {
            ...
            RequestFilterFields = "Payroll Period", Company, "Employee No";
            ...
            begin
                ...
                Difference := 0;
                Desc := '';
                Message('last amout is %1', Lastmonth);
                ...
                if Assignmat.FindFirst then
                    ...
                    else if not Assignmat.FindFirst then
                        LastMonthVal := 0;
                end;

                Difference := "Assignment Matrix-X".Amount - LastMonthVal;

                Message('ass amount is %1..#...lastmonth is %2 ..# ..Last code is %3', "Assignment Matrix-X".Amount, LastMonthVal, "Assignment Matrix-X".Code);
