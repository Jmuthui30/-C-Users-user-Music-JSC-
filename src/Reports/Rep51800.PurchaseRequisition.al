report 51800 "Purchase Requisition"
{
    // version THL- PRM 1.0
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Purchase Requisition.rdl';
    ...
    dataset
    {
        dataitem(Payments; "Requisition Header")
        {
            ...
            column(ChequeNo; Payments.Reason)
            {
            }
            ...
            column(PaymentNarration; Payments.Reason)
            {
            }
            ...
            begin
                ...
                ApprovalEntries.SetRange(ApprovalEntries."Table ID", 51800);
