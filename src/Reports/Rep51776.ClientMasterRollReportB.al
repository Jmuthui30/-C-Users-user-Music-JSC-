report 51776 "Client Master Roll ReportB"
{
    // version THL- Client Payroll 1.0
    DefaultLayout = RDLC;
    //RDLCLayout = './Reports/SSRS/Client Master Roll Report2.rdlc';
    RDLCLayout = './Reports/SSRS/Client Master Roll ReportB.rdlc';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("No.") where("Company Code" = filter('PAYROLLB'));
