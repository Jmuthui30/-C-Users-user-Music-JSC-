report 52039 "Payroll Reconciliation new"
{
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './src/report_layout/PayrollReconciliationnew.rdl';
        ...
        dataitem(Deductions; Deductions)
        {
            ...
            dataitem(EmpDed; Employee)
            {
                ...
                begin
                    ...
                    Assignmat.SetRange(Assignmat."Payroll Period", Thismonth);
                    if Assignmat.Find('+') then
                        ThisMonthVal := Assignmat.Amount;//+ Assignmat."Non-Interest Loan";
                    Difference := ThisMonthVal - LastMonthVal;
                    if Difference = 0 then
                        CurrReport.Skip();
                end;
