report 51473 "My P9A - Client"
{
    // version THL- Client Payroll 1.0
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/My P9A - Client.rdlc';
    UseRequestPage = true;
        ...
        dataitem(Employee; "Client Employee Master")
        {
            ...
            dataitem("Payroll Period"; "Payroll Period")
            {
                ...
                begin
                    ...
                    // Get Owner Occupier
                    //END;
                    GetPaye.CalculateTaxableAmount(Employee."No.", "Payroll Period"."Starting Date", IncomeTax, TaxableAmount, RetirementVar, Employee."Company Code");
            ...
            dataitem(Earnings; Earnings)
            {
                ...
                column(DataItem171; Where_actual_cost_is_higher_than_given_monthly_rates_of_CaptionLbl)
                {
                }
    ...
    Where_actual_cost_is_higher_than_given_monthly_rates_of_CaptionLbl: Label '* Where actual cost is higher than given monthly rates of benefits then the actual cost is brought to charge in full';
