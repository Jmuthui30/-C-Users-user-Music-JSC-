report 51460 "Client Earnings"
{
    // version THL- Client Payroll 1.0
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Client Earnings.rdlc';
    ...
    dataset
    {
        dataitem("Client Payroll Matrix"; "Client Payroll Matrix")
        {
            ...
            RequestFilterFields = Company, "Payroll Period", "Code";
            RequestFilterHeading = 'Client Earnings';
            ...
            column(Assignment_Matrix_X1__Assignment_Matrix_X1__Amount; "Client Payroll Matrix".Amount)
            {
            }
            ...
            begin
                Deductions.SetRange(Company, "Client Payroll Matrix".Company);
