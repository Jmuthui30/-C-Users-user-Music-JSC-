report 51425 "Payslip"
{
    // version THL- Payroll 1.0
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Payslip.rdlc';
    ...
    dataset
    {
        dataitem(Employee; "Employee Master")
        {
            ...
            column(Name1; NAVEmployee."First Name" + '  ' + NAVEmployee."Last Name")
            {
            }
            ...
            column(PayrollNo; Employee."Payroll No")
            {
            }
            column(PIN; Employee."PIN Number")
            {
            }
            column(AC_No; Employee."Bank Account Number")
            {
            }
            column(NSSF; Employee."NSSF No")
            {
            }
            column(SHIF; Employee."SHIF No")
            {
            }
            column(PINCaption; PINLbl)
            {
            }
            column(AcCaption; AccNoLBL)
            {
            }
            column(NSSFCaption; NSSFLbl)
            {
            }
            column(TimeToRetire; TimeToRetirement)
            {
            }
            column(Retirement; RetirementDate)
            {
            }
            column(SHIFCaption; SHIFLbl)
            {
            }
            ...
            begin
                ...
                if NAVEmployee.Get(Employee."No.")then // Get Basic Salary
                    Earn.Reset;
               ...
               */
                ...
                i:=i+1;
                   ...
                   //
                    ...
                    i:=i+1;
                    IF EmpBank.GET("Bank Code","Bank Branch") THEN
                     BEGIN
                ...
                */
                ...
                if NAVEmployee.Get(Employee."No.")then begin
                    if(NAVEmployee."Employment Date" <> 0D)then begin
                        D:=CalcDate('<+60Y>', NAVEmployee."Birth Date");
                        RetirementDate:=Format(D);
                        TimeToRetirement:=Dates.DetermineAge(Today, D) + ' To Retirement';
                    end;
                end;
            end;
    ...
    BalanceAmt: array[3, 100]of Text[60];
    GrossPay: Decimal;
    ...
    Employee_No_CaptionLbl: Label 'Payroll No:';
