report 51472 "My Payslip - Client"
{
    // version THL- Client Payroll 1.0
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/My Payslip - Client.rdlc';
                    ...
                    repeat LoanBalance:=0;
                        ...
                        if PayrollMatrix.Find('-')then begin
                            ...
                            if LoanBalances.Find('-')then begin
                                repeat if loanType.Get(LoanBalances."Client Loan Product Type")then begin
    ...
    PAYE: Decimal;
    TaxCharged: Decimal;
    Deduct: Record "Deductions Master";
    LoanBalance: Decimal;
