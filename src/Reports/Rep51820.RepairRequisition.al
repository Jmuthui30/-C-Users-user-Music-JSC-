report 51820 "Repair Requisition"
{
    //Ibrahim Wasiu
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Repair Requisition.rdl';

    dataset
    {
        dataitem(Payments; "Repair Header")
        {
            ...
            column(RepairStartDate; Payments."Repair Start Date")
            {
            }
            column(RepairEndDate; Payments."Repair Start Date")
            {
            }
            column(No; Payments."No.")
            {
            }
            column(RepairType; Payments."Repair Type")
            {
            }
            ...
            column(RepairNotes; Payments."Repair Notes")
            {
            }
            column(RepairServiceLevel; Payments."Repair Service Level")
            {
            }
            column(OnBehalfOf; Payments."Employee Name")
            {
            }
            column(Reason; Payments.Reason)
            {
            }
            column(Fault_Area; Payments."Fault Area")
            {
            }
            column(Fault_Symptom; Payments."Fault Symptom")
            {
            }
            column(Fault_Type; Payments."Fault Type")
            {
            }
            column(Fault_Date; Payments."Fault Date")
            {
            }
            ...
            dataitem("Repair Lines"; "Repair Lines")
            {
                DataItemLink = "Repair No"=FIELD("No.");

                column(Description; "Repair Lines".Description)
                {
                }
                column(Quantity; "Repair Lines".Quantity)
                {
                }
                column(UoM; "Repair Lines"."Unit of Measure")
                {
                }
                column(UnitCost; "Repair Lines"."Unit Price")
                {
                }
                column(GrossAmount; "Repair Lines".Amount)
                {
                }
            }
            ...
            begin
                ...
                ApprovalEntries.SetRange(ApprovalEntries."Table ID", 51935);
