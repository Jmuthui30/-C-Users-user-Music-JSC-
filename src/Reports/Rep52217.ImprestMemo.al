report 52217 "Imprest Memo"
{
    ApplicationArea = All;
    Caption = 'Imprest Memo';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Reports/SSRS/Imprest Memo.rdl';

    dataset
    {
        dataitem(Payments; "Imprest Memo Header")
        {
            ...
            column(From; Payments."Sender Name")
            {
            }
            column(To; Payments."Recipient Name")
            {
            }
            ...
            begin
                ...
                // if BankRec.Get(Payments."Paying Bank Code") then
                //     BankName := BankRec.Name;
                // SN := 0;
                // //Get Dimensions
                // if DimValue.Get('REGION', Payments."Global Dimension 1 Code") then
                //     Region := DimValue.Name;
                // if DimValue.Get('STATES', Payments."Global Dimension 2 Code") then
                //     State := DimValue.Name;
                // if DimValue.Get('DEPT', Payments."Global Dimension 3 Code") then
