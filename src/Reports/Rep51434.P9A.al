report 51434 "P9A"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/P9A.rdlc';
    UseRequestPage = true;
    ...
    dataset
    {
        dataitem(Employee; "Employee Master")
        {
            ...
            dataitem(Earnings; Earnings)
            {
                ...
                column(DataItem171; Where_actual_cost_is_higher_than_given_monthly_CaptionLbl)
                {
                }
    ...
    XCaptionLbl: Label 'X';
    TOTAL_BENEFIT_IN_YEARCaptionLbl: Label 'TOTAL BENEFIT IN YEAR', MaxLength = 250;
    Where_actual_cost_is_higher_than_given_monthly_CaptionLbl: Label '* Where actual cost is higher than given monthly rates of benefits then the actual cost is brought to charge in full', MaxLength = 999;
    ...
    EMPLOYERS_LOAN____Kshs_RATE__________RATE_DIFFERENCE_____PRESCRIBED_RARE___EMPLOYERS_Lbl: Label 'EMPLOYERS LOAN   =Kshs..........................@............% RATE          RATE DIFFERENCE    (PRESCRIBED RARE - EMPLOYERS RATE)  =    15%  -   ..........%  =   ........%', MaxLength = 999;
    MONTHLY_BENEFIT_____________RATE_DIFFERENCE_X_LOAN__12_X________Kshs________Lbl: Label 'MONTHLY BENEFIT            (RATE DIFFERENCE X LOAN)/12    =      .................................%     X        Kshs. ......................../12   = Kshs...............................', MaxLength = 999;
