...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Payment Voucher.rdlc';
    dataset
    {
        dataitem(Payments; Payments)
        {
            ...
            column("Department"; Payments."Shortcut Dimension 2 Code")
            {
            }
            ...
            dataitem("PV Lines"; "Payment Lines")
            {
                ...
                column(Project; "PV Lines"."Shortcut Dimension 1 Code")
                {
                }
                column(Donor; "PV Lines"."Shortcut Dimension 2 Code")
                {
                }
