report 52104 "Petty Cash Request"
{
    // version THL- ADV.FIN 1.0
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Petty Cash Request.rdlc';

    dataset
    {
        dataitem(Payments; "Expense Claim Header")
        {
            ...
            dataitem("Expense Claim Details"; "Expense Claim Details")
            {
            ...
            begin
                ...
                ApprovalEntries.SetRange(ApprovalEntries."Table ID", 52105);
