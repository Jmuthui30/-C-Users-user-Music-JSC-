report 52216 "Housing Levy"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Housing Levy.rdlc';
    ...
    dataset
    {
        dataitem(Employee; "Client Employee Master")
        {
            ...
            column(Basic___Regular_Allowances; "Basic + Regular Allowances")
            {
            }
            ...
            begin
                ...
                Employee.CalcFields("Basic + Regular Allowances");
                if Employee."Basic + Regular Allowances" = 0 then begin
                    CurrReport.Skip()end;
                ...
                begin
                    ...
                    if Earn.Find('-')then begin
                        ...
                        if ExportCSV then begin
                            LineNo:=LineNo + 1;
                            CSVBuffer.InsertEntry(LineNo, 1, Employee."ID Number");
                            CSVBuffer.InsertEntry(LineNo, 2, format(Employee."Full Name"));
                            CSVBuffer.InsertEntry(LineNo, 3, format(Employee."PIN Number"));
                            CSVBuffer.InsertEntry(LineNo, 4, format("Basic + Regular Allowances", 0, 2));
                            CSVBuffer.InsertEntry(LineNo, 5, Format(0, 2));
                        end;
                    end;
                end;
            end;
