report 51848 "Imprest Surender NCIC"
{
    // version THL- ADV.FIN 1.0
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Imprest Surender NCIC.rdlc';
    ...
    dataset
    {
        dataitem(Payments; "Imprest Header")
        {
            ...
            column(Donor; Payments."Global Dimension 2 Code")
            {
            }
            ...
            column(TravelToLocation; Payments."TDY Location")
            {
            }
            column(Desc; Payments.Description)
            {
            }
            dataitem("Imprest Details"; "Imprest Details")
            {
                ...
                column(GrossAmount; "Imprest Details"."Actual Spent")
                {
                }
                ...
                column(VodeCode; "Imprest Details"."Global Dimension 2 Code")
                {
                }
                column(AccNo; "Imprest Details"."Account No")
                {
                }
                column(LineNo; "Imprest Details"."Line No")
                {
                }
            }
            ...
            begin
                ...
                ApprovalEntries.SetRange(ApprovalEntries."Table ID", 50463);
