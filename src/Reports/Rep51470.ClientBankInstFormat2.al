report 51470 "Client Bank Inst Format 2"
{
    // version THL- Client Payroll 1.0
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSRS/Client Bank Inst Format 2.rdlc';
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "Company Code", "Pay Period Filter", "Employee Group";
