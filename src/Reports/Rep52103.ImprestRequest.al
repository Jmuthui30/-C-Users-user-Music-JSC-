// report 52103 "Imprest Request"
// {
//     DefaultLayout = RDLC;
//     UsageCategory = ReportsAndAnalysis;
//     ApplicationArea = All;
//     RDLCLayout = './Reports/SSRS/Imprest Request.rdl';
...
//             {
//             }
//             column(BusinessUnit; Payments."Shortcut Dimension 2 Code")
//             {
//             }
//             column(BankCode; Payments."Paying Bank Account")
//             {
//             }
//             column(Designation; "Shortcut Dimension 1 Code")
//             {
//             }
//             column(Employee_No_; "Staff No.")
//             {
//             }
//             column(Job_Title; "Shortcut Dimension 2 Code")
//             {
//             }
//             column(Bank; BankName)
//             {
//             }
//             column(NetAmount; Payments."Total Net Amount")
//             {
//             }
...
//             {
//             }
//             column(Global_Dimension_1_Code; "Shortcut Dimension 1 Code")
//             {
//             }
//             column(Global_Dimension_2_Code; "Shortcut Dimension 2 Code")
//             {
//             }
...
//             {
//             }
//             column(Cashier; Payments."Surrender Posted By")
//             {
//             }
...
//             {
//             }
//             // column(Proposed_Itinerary_Date;"Proposed Itinerary Date")
//             // {
//             // }
...
//             {
//             }
//             column(Location_Description; "Location Description")
//             {
//             }
//             column(Request_Posted_Date; "Request Posted Date")
//             {
//             }
...
//                 SN:=0;
//                 //Get Dimensions
//                 if DimValue.Get('REGION', Payments."Global Dimension 1 Code")then Region:=DimValue.Name;
//                 if DimValue.Get('STATES', Payments."Global Dimension 2 Code")then State:=DimValue.Name;
//                 if DimValue.Get('DEPT', Payments."Global Dimension 3 Code")then Department:=DimValue.Name;
//                 //
