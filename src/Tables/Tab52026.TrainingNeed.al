table 52026 "Training Need"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'Open,Closed,Application,Cancelled,Pending Plan Approval,Approved Plan';
            OptionMembers = Open,Closed,Application,Cancelled,"Pending Plan Approval","Approved Plan";
            Caption = 'Status';
        }
