table 51480 "Client Earnings"
{
    // version THL- Client Payroll 1.0
    DrillDownPageID = "Client Earnings";
    LookupPageID = "Client Earnings";
    ...
    fields
    {
        ...
        field(47; "Regular Cash Allowance"; Boolean)
        {
        }
    }
    keys
