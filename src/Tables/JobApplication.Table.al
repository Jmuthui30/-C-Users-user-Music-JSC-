table 52003 "Job Application"
{
    ...
    fields
    {
        ...
        field(2; "Applicant No."; Code[50])
        {
            ...
            TableRelation = if ("Applicant Type" = const(External)) Applicant where(Submitted = const(true))
            else
                ...
                case "Applicant Type" of
                    "Applicant Type"::External:
                        begin
                            ...
                            "Applicant Name" := Applicants.FullName();
        ...
        field(6; "Job Applied Code"; Code[50])
        {
            ...
            begin
                ...
                Needs.Reset();
                Needs.SetRange(Needs."Job ID", "Job Applied Code");
                if Needs.Find('-') then
                    "Job Title" := Needs.Name;
            end;
        }
        ...
        {
            CalcFormula = average("Interview Stage"."Marks Awarded" where("Vacancy No." = field("No."), "Interview Type" = const(Practical)));
        ...
        {
            CalcFormula = average("Interview Stage"."Marks Awarded" where("Vacancy No." = field("No."), "Interview Type" = const(Oral)));
            FieldClass = FlowField;
        ...
        {
            CalcFormula = average("Interview Stage"."Marks Awarded" where("Vacancy No." = field("No.")));
            FieldClass = FlowField;
        ...
        field(20; "Invite Date"; Date) { }
        field(21; "InviteTime"; Time) { }
