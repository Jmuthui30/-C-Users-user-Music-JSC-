table 51431 "Earnings"
{
    ...
    fields
    {
        ...
        {
            OptionMembers = "Flat amount", "% of Basic pay", "% of Gross pay", "% of Insurance Amount", "% of Taxable income", "% of Basic after tax", "Based on Hourly Rate", "Based on Daily Rate", "% of Salary Recovery", "% of Loan Amount", "% of SHIF", "% of Basic + Regular Allowances";
        }
        ...
        field(18; "Employee Filter"; Code[20])
        {
            FieldClass = FlowFilter;
            TableRelation = "Payroll Period";
        }
