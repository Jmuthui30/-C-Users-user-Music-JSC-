table 51903 "Appraisal Lines"
{
    ...
    fields
    {
        ...
        {
            OptionMembers = " ",Objectives,"Core Values","Core Competencies","Managerial and Supervisory","Annual Appraisal","Mid-year Appraisal";
        ...
        field(42; "Workplan Description"; Text[250])
        {
            Caption = 'Workplan Description';
            // TableRelation = "Appraisal Workplan Code"."Description" where(Code = field("Workplan Code"));
        }
