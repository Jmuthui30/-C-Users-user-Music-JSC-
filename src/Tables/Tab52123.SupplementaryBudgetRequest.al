table 52123 "Supplementary Budget Request"
{
    ...
    begin
        if "No." = '' then begin
            ...
            if NoSeriesMgt.AreRelated(AdvanceFinSetup."Suppl. Budget Request Nos",xRec."No. Series") then
            "No. Series":=xRec."No. Series"
            else
            "No. Series":=AdvanceFinSetup."Suppl. Budget Request Nos";
