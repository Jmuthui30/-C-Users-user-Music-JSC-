table 51469 "Client Loan Application"
{
    fields
    {
        ...
        field(3; "Client Loan Product Type"; Code[20])
        {
            TableRelation = "Client Loan Product".Code;
        ...
        {
            TableRelation = "Client Employee Groups".Code;
        }
    ...
    keys
    {
        key(Key1; "Loan No", "Client Loan Product Type")
        {
        }
        key(Key2; "Payroll Group", "Client Loan Product Type")
        {
        }
    }
    fieldgroups
    ...
    var
        ...
        LoanTypeRec: Record "Client Loan Product";
        LoopEndBool: Boolean;
        LineNoInt: Integer;
        PeriodCode: Code[10];
